...
class PODOFO_DOC_API PdfDestination {
 public:
     ...
     */
    inline PdfObject* Podofo_GetObject();
     ...
     *  \returns the internal PdfObject
     */
    inline const PdfObject* Podofo_GetObject() const;
...
// 
// -----------------------------------------------------
inline PdfObject* PdfDestination::Podofo_GetObject()
{
    return m_pObject;
}
...
// 
// -----------------------------------------------------
inline const PdfObject* PdfDestination::Podofo_GetObject() const
{
    return m_pObject;
}
